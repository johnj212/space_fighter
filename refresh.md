User Query: When the boss is defeated the level ends but I would like it to contiune tunil the total number of aliens killed are completed inc the boss.
